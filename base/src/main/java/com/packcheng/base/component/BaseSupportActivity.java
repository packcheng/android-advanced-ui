...
/**
 * 项目支持多Fragment的Activity基类
 * <p/>
 * 复制 {@link me.yokeyword.fragmentation.SupportActivity}
 * 修改其中的 {@link #onCreate(Bundle)},mDelegate的调用要在super之前，否则报空指针异常
 *
 * @author packcheng
 * @date 2020-02-05 15:22
 */
public abstract class BaseSupportActivity<V extends ViewDataBinding, VM extends BaseViewModel>
    ...
    /**
     * It is recommended to use {@link BaseSupportFragment#startWithPopTo(ISupportFragment, Class, boolean)}.
     *
